...
{
    [Serializable]
    public class PhysicalEmployee : IEmployee
    {
        public string Type { get; } = "Physical";
        ...
        public PhysicalEmployee(string firstName, string lastName, int age)
        {
        ...
        public PhysicalEmployee(SerializationInfo info, StreamingContext context)
        {
